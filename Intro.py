...
class splash:
    def __init__(self):
      ...
      Label(main, text="Name : Daniyal Alam",font="roboto 16 bold",bg="snow").place(x=445+5, y=260)
      Label(main, text="Type: POS", font="roboto 16 bold", bg="snow").place(x=450, y=310)
      Label(main, text="Email: scdaniyalalam@outlook.com",font="roboto 16 bold",bg="snow").place(x=445+5, y=360)
      Label(main, text="Ph.no: +923112154661",font="roboto 16 bold",bg="snow").place(x=445+5, y=410)
