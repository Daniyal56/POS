...
class Admin:
    ...
    def buildprodtable(self):
         ...
         Button(self.formframe, text="Update", font="roboto 11 bold",bg="#FFFFFF", bd=5, width=10, height=2,
         command=self.changeprodtable).place(x=105, y=361)
         Button(self.formframe, text="Remove", font="roboto 11 bold",bg="#FFFFFF", bd=5, width=10, height=2,
    ...
    def buildusertable(self):
         ...
         profiles=mycombobox(self.formframe1, font="roboto 14", width=23, textvariable=self.accedit)
         profiles.place(x=162,y=245,height=40)
         profiles.set_completion_list(['ADMIN','USER'])
         Button(self.formframe1, text="Create a User", font="roboto 12 bold", bg="#FFFFFF", bd=5, width=12, height=2,
                command=self.adduser).place(x=0, y=10)
         Button(self.formframe1, text="Update", font="roboto 12 bold", bg="#FFFFFF", bd=5, width=10, height=2,
                command=self.changeusertable).place(x=145, y=381)
         Button(self.formframe1, text="Remove", font="roboto 12 bold", bg="#FFFFFF", bd=5, width=10, height=2,
